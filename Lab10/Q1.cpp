...
int main()
{
  ...
  // Creating raw sockets with ETH_P_ALL protocol which listens to all activity on the network card
  ...
  while (1)
  {
    ...
    // recvfrom is a blocking call that listens to all interfaces
